...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n pll -lang verilog -synth synplify -arch xo2c00 -type pll -fin 50 -fclkop 133 -fclkop_tol 0.5 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 -lock  */
/* Thu Mar 20 12:05:08 2025 */


`timescale 1 ns / 1 ps
module pll (CLKI, CLKOP, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire LOCK;
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 133.333333
