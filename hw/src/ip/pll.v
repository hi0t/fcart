...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n pll -lang verilog -synth synplify -arch xo2c00 -type pll -fin 50 -fclkos 133 -fclkos_tol 0.5 -fclkos2 133 -fclkos2_tol 0.5 -bypassp -trims 0 -phases 0 -trims_r -phases2 0 -phase_cntl STATIC -fb_mode 2 -lock  */
/* Mon Mar 31 01:19:17 2025 */
...
module pll (CLKI, CLKOP, CLKOS, CLKOS2, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOS_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS2="133.333333" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS2 133.333333
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 133.333333
