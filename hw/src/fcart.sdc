...
#set_max_delay -from [get_ports {CPU_ADDR[*]}] -to {mux8bit*} 10
#set_max_delay -from {mux8bit*} -to [get_ports {CPU_DATA[*]}] 10
#set_max_delay -from [get_ports {CPU_RW}] -to {mux8bit*} 10
#set_max_delay -from [get_ports {ROM_CE}] -to {mux8bit*} 10
#set_max_delay -from [get_ports {PPU_RD}] -to {mux8bit*} 10
#set_max_delay -from [get_ports {PPU_ADDR[*]}] -to {mux8bit*} 10
#set_max_delay -from {mux8bit*} -to [get_ports {PPU_DATA[*]}] 10
