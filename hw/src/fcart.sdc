...
#set_multicycle_path -from {sdram|*} -to {api|*} -start -setup 2
#set_multicycle_path -from {sdram|*} -to {api|*} -start -hold 1
#set_multicycle_path -from {api|*} -to {sdram|*} -setup 2
#set_multicycle_path -from {api|*} -to {sdram|*} -hold 1
